...
trait UserAgentTrait
{
	...
	{
		$ch = curl_init();
		// $curlurl = "https://book.douban.com/subject/30155731/reviews?sort=time";
		$referurl = "https://book.douban.com";
		$ip=mt_rand(11, 191).".".mt_rand(0, 240).".".mt_rand(1, 240).".".mt_rand(1, 240);   //随机ip
		$agentarry = self::getUserAgent();
		...
		curl_setopt($ch, CURLOPT_PROXY, "61.135.217.7"); //代理服务器地址
		...
		curl_setopt($ch, CURLOPT_REFERER, 1);  //模拟来源网址
